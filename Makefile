#
# OMNeT++/OMNEST Makefile for wsnfuture
#
...
clean:
	$(qecho) Cleaning...
	$(Q)-rm -rf $O
	$(Q)-rm -f wsnfuture wsnfuture.exe libwsnfuture.so libwsnfuture.a libwsnfuture.dll libwsnfuture.dylib
	$(Q)-rm -f ./*_m.cc ./*_m.h
